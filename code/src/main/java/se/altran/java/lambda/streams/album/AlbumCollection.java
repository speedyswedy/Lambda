...
public class AlbumCollection {
    private static List<Album> albums = Arrays.asList(new Album("Ten", "Pearl Jam", 1992, Rating.FANTASTIC),
            ...
            new Album("Made of Bricks", "Kate Nash", 2007, Rating.GOOD),
            new Album("Pablo Honey", "Radiohead", 1993, Rating.FANTASTIC),
            new Album("Original Pirate Material", "The Streets", 2002, Rating.GREAT),
